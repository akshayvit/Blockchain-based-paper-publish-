...
export function Signup(props) {
    ...
    const changename=(event) => {
        setnuame(event.target.value.split("@")[0]+parseInt(10000*Math.random()));
    }
    const signup=async ()=>{ 
        
        await fetch('https://api.paytripapp.com/user/J220701/signup',{
            method: 'POST',
            mode: 'cors',
            headers: {
            ...
            if(data.includes("fail")) {
                ...
                toast.success('Signing You Up...', {
                 ...
                 setTimeout(()=>{
                    return <Login emailaddress={email} password={pass}/>;
                 },2000);
            }
        })
};
